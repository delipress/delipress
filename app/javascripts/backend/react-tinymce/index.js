...
var _lodashLang = require('underscore');

var _lodashLangIsEqual2 = _lodashLang._.isEqual

var _lodashLangClone2 = _lodashLang._.clone

var _helpersUuid = require('javascripts/backend/react-tinymce/helpers/uuid');

var _helpersUuid2 = _interopRequireDefault(_helpersUuid);

var _helpersUcFirst = require('javascripts/backend/react-tinymce/helpers/ucFirst');
...
var TinyMCE = _react2['default'].createClass({
  ...
  componentDidMount: function componentDidMount() {
    var config = (0, _lodashLangClone2)(this.props.config);
    this._init(config);
  },

  componentWillReceiveProps: function componentWillReceiveProps(nextProps) {
    if (!(0, _lodashLangIsEqual2)(this.props.config, nextProps.config)) {
      this._init(nextProps.config, nextProps.content);
    }
    if (!(0, _lodashLangIsEqual2)(this.props.id, nextProps.id)) {
      this.id = nextProps.id;
    }
  },

  shouldComponentUpdate: function shouldComponentUpdate(nextProps) {
    return !(0, _lodashLangIsEqual2)(this.props.content, nextProps.content) || !(0, _lodashLangIsEqual2)(this.props.config, nextProps.config);
  },
