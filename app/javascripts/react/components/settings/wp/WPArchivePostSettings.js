...
import PostTypes from 'javascripts/react/components/settings/wp/PostTypes'
...
class WPArchivePostSettings extends BaseWPArchiveSettings  {
        ...
        return (
            <div className="container__settings__attributes settings__default">
                <span className="delipress__builder__side__title">
                    {translationDelipressReact.Builder.component_settings.wp_archive_post.title}
                </span>
                <PictureSettings
                    toggleOption={(value) => {
                ...
                <PostTypes
                    changeChoicePostType={(obj) => {
                        this.saveOptionValue("post_type", obj)
                        this.props.onChangeChoicePostType({
                          post_type : obj.value
                        })
                    }}
                    valueOption={post_type}
                />
                <Posts
...
export default connect(mapStateToProps)(WPArchivePostSettings)
